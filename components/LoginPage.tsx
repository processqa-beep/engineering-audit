...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  const handleGoogleSignInClick = () => {
    // If email is typed in, use it; otherwise default prompt to mehul.chikhaliya@borosil.com
    const targetEmail = emailInput.trim() || 'mehul.chikhaliya@borosil.com';
    handleBorosilAuth(targetEmail, nameInput);
  };
