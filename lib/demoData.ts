...
export const initialEmployees: Employee[] = [
  { id: 'EMP-01', name: 'Mehul Chikhaliya',  role: 'Admin',       department: 'Process QA',  email: 'mehul.chikhaliya@borosil.com',  active: true },
  { id: 'EMP-02', name: 'Rakesh Gohil',      role: 'Auditor',     department: 'Engineering', email: 'rakesh.gohil@borosil.com',      active: true },
  { id: 'EMP-03', name: 'Pavan Kumar',       role: 'Engineering', department: 'Maintenance', email: 'pavan.kumar@borosil.com',       active: true },
  { id: 'EMP-04', name: 'Process QA Admin',  role: 'QA',          department: 'Process QA',  email: 'process.qa@borosil.com',        active: true },
];
