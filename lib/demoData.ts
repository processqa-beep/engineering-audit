...
export const initialEmployees: Employee[] = [
  { id: 'EMP-01', name: 'Mehul Chikhaliya',  role: 'Admin',       department: 'Process QA',  email: 'mehul.chikhaliya@borosil.com', password: 'mehul@1473', status: 'Approved', emailParticipation: 'TO', sectionScope: 'ALL', triggerOn: 'ANY_NG', active: true },
...
// ──────────────────────────────────────────────────────────────────────────────
// AUDIT DATA — EMPTY (Created dynamically when user submits audits)
// ──────────────────────────────────────────────────────────────────────────────
...
export const defaultSettings: SystemSettings = {
  supabaseUrl: 'https://nywznyvvqhiiktvoskkv.supabase.co',
  supabaseAnonKey: 'sb_publishable_wEYpcobIlO1eWIjA7cRdFQ_SkMrwmpZ',
